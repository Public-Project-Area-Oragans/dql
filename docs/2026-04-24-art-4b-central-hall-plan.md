...
**Spec:** [docs/2026-04-24-art-4b-central-hall-redo-design.md](2026-04-24-art-4b-central-hall-redo-design.md)
...
- `docs/2026-04-24-session-handoff.md` — 세션 종료 시
...
- `docs/PIXEL_ART_PROGRESS.md` — art-4b 섹션 + 누적 22→32/1000 업데이트
- `docs/PIXEL_ART_ASSET_MANIFEST.md` — 신규 에셋 등록
...
**Files:**
- Modify: `docs/PIXEL_ART_PROGRESS.md`
- Modify: `docs/PIXEL_ART_ASSET_MANIFEST.md`
...
```bash
git add docs/PIXEL_ART_PROGRESS.md docs/PIXEL_ART_ASSET_MANIFEST.md
git commit -m "$(cat <<'EOF'
...
- Spec: `docs/2026-04-24-art-4b-central-hall-redo-design.md`
- Plan: `docs/2026-04-24-art-4b-central-hall-plan.md`
...
**Files:**
- Create: `docs/2026-04-24-session-handoff.md`
- Modify: `CLAUDE.md` (참조 링크 블록)

- [ ] **Step 1: `docs/2026-04-24-session-handoff.md` 작성**
...
[ ] docs/2026-04-24-session-handoff.md 읽기
[ ] docs/PIXEL_ART_PROGRESS.md 누적 31/1000 확인
...
- `docs/2026-04-22-session-handoff.md` — 직전 세션
- `docs/2026-04-24-art-4b-central-hall-redo-design.md` — art-4b spec
- `docs/2026-04-24-art-4b-central-hall-plan.md` — art-4b plan
```
...
기존:
```markdown
- [**세션 핸드오프 (2026-04-22)**](docs/2026-04-22-session-handoff.md) — **새 세션 진입 시 최우선 읽기. ...**
```

다음으로 교체:
```markdown
- [**세션 핸드오프 (2026-04-24)**](docs/2026-04-24-session-handoff.md) — **새 세션 진입 시 최우선 읽기. art-4b 중앙 홀 풀샷 재작업 완료 · 11차 릴리즈 · art-5 착수 대기.**
- [세션 핸드오프 (2026-04-22)](docs/2026-04-22-session-handoff.md) — 직전 세션 (art-4 + 10/10.5차)
```

- [ ] **Step 3: 커밋**

```bash
git add docs/2026-04-24-session-handoff.md CLAUDE.md
git commit -m "$(cat <<'EOF'
...
- Spec: `docs/2026-04-24-art-4b-central-hall-redo-design.md`
- 선행 핸드오프: `docs/2026-04-22-session-handoff.md`
- 픽셀아트 Bible: `docs/PIXEL_ART_ASSET_BIBLE.md`
