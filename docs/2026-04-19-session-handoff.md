...
- `docs/2026-04-19-requirements-consolidated.md` — 재작업 요구사항 정리 (R0~R7 + 에스컬레이션)
- `docs/2026-04-19-ascii-to-widget-migration-design.md` — ASCII 이주 설계 (approach A/B/C)
- `docs/PIXEL_ART_ASSET_BIBLE.md`, `docs/PIXEL_ART_ASSET_MANIFEST.md` — 픽셀아트 스타일·아키텍처 규격
- `docs/PIXEL_ART_ANCHOR_APPROVAL.md` — art-0 승인 게이트
- `docs/PIXEL_ART_PROGRESS.md` — art-0~9 진행 추적
...
[ ] docs/2026-04-19-session-handoff.md (본 문서) 읽기
[ ] docs/2026-04-19-requirements-consolidated.md §3.1 표 최신 상태 확인
...
- `docs/2026-04-18-session-handoff.md` — 직전 세션 (완료)
- `docs/2026-04-19-requirements-consolidated.md` — R0~R7 원점 문서
- `docs/2026-04-19-ascii-to-widget-migration-design.md` — R2 기술 설계
- `docs/PIXEL_ART_ASSET_BIBLE.md` / `docs/PIXEL_ART_ASSET_MANIFEST.md` — 스타일·아키텍처
- `docs/PIXEL_ART_ANCHOR_APPROVAL.md` — art-0 승인 게이트
- `docs/PIXEL_ART_PROGRESS.md` — art-* 누적 추적
- `C:/Users/deepe/.claude/plans/optimized-yawning-rocket.md` — 픽셀아트 이주 9-PR 플랜
- `docs/2026-04-18-work-history.md` / `docs/2026-04-18-phase-plan.md` — P0 컨텍스트
