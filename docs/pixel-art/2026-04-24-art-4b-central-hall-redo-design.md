...
| 파일 | 변경 |
|---|---|
| `docs/pixel-art/PIXEL_ART_PROGRESS.md` | art-4b 섹션 추가. 누적 22 → 32/1000 업데이트 |
| `docs/pixel-art/PIXEL_ART_ASSET_MANIFEST.md` | 신규 9 에셋 등록 (pillar_right 는 mirror 주석) |
| `docs/handoffs/2026-04-24-session-handoff.md` | 세션 종료 시 작성 |
...
- `docs/handoffs/2026-04-22-session-handoff.md` §2.1 — art-4b 요구사항 원천
